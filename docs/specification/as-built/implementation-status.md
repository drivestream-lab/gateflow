...
| Gap | Status |
|-----|--------|
| W6 wave implementation progress | **code complete (unit)** — board [#167](https://github.com/drivestream-lab/gateflow/issues/167); live verify human at wave-acceptance (`verify_wave_implementation`); Draft PR pending forge |
