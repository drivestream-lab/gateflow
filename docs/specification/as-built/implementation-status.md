...
**INIT-GATEFLOW-012 W4 status:** **unit-complete** (loop-spec) — live pending human `verify_wave_start` + `wave-accepted` on tip. Board [#189](https://github.com/drivestream-lab/gateflow/issues/189).
