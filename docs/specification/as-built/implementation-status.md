...
| INIT-008 (006A) | Pin `authorization` dual mode + wave-pr after loop-spec | [`product/INIT-GATEFLOW-008-gateflow.md`](../product/INIT-GATEFLOW-008-gateflow.md) | **W0 human_approved** (2026-07-30) — merge [#96](https://github.com/drivestream-lab/gateflow/pull/96) @ `029481e` (tip `9e07a5a`); parse + Pass-1 unit hygiene; W1/W2 not started; still blocks INIT-007 dogfood until W0/W1 on `develop` |
