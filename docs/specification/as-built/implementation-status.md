...
**INIT-GATEFLOW-013 W4 status:** **implemented** (Pass-1) — board [#204](https://github.com/drivestream-lab/gateflow/issues/204); live smoke pending human wave-acceptance.
