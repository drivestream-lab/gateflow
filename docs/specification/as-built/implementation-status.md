...
**INIT-GATEFLOW-012 W1 status:** **code complete (unit)** — `make check` / `make test` green on Pass-1; co-shipped `verify_workspace_lifecycle` **not** claimed live here. PE-1 remount of net-new pin shapes deferred to W2.
