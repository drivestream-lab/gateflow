...
| W3 | Delivery Scorecard API | **code complete (unit)** | Board [#233](https://github.com/drivestream-lab/gateflow/issues/233); `GET /api/v1/metrics/delivery-scorecard`; unit `test_delivery_scorecard_service`; live `verify_delivery_scorecard` (human at wave-acceptance) |
