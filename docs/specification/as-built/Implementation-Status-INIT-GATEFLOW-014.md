...
| W3 | Dead-door deletion + wipe | **human_approved** | Board [#218](https://github.com/drivestream-lab/gateflow/issues/218); Draft PR [#224](https://github.com/drivestream-lab/gateflow/pull/224) accept `52b969d` label `wave-accepted`; Ground-Report W3 **pass**; Learning-Extract W3 `items: []` |
