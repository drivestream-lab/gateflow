...
| W3 | Dead-door deletion + wipe | implemented (awaiting wave-acceptance) | Board [#218](https://github.com/drivestream-lab/gateflow/issues/218); Wave-Execution W3; live: `verify_dead_doors_deleted` + `verify_wipe_cutover` |
