...
| Date | 2026-08-11 |
| Wave head (exact) | Accept tip `0c8e8a5782f794802eddc2200e98e22010c8263e` (`wave-accepted`); Pass-2 / reviewed head stamped after this publish |
...
- Reviewed head SHA (Pass-2 tip): *stamped after commit-workspace publish*
