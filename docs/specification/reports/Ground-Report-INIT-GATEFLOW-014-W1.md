...
| Date | 2026-08-11 |
| Wave head (exact) | Accept tip `ecb7fbd863b0b6b4ed305cc83acc98aff2a69f5b` (`wave-accepted`); Pass-2 tip recorded after `/commit-workspace` |
...
- Reviewed head SHA (Pass-2 tip): **see handoff after `/commit-workspace`**
...
handoff:
  ...
  signals:
    ...
    assigned_reqs:
      ...
      - REQ-45
      - REQ-47
    reviewed_head_sha: ecb7fbd863b0b6b4ed305cc83acc98aff2a69f5b
