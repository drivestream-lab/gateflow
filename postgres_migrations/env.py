"""Alembic environment configuration for gateflow PostgreSQL migrations."""
...
import src.database.postgres.schema.programme_meta_pr_schema  # noqa: F401 — register ORM tables
